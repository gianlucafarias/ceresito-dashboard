...
export type DashboardCategoryIconKey = (typeof CATEGORY_ICON_OPTIONS)[number]["value"];

const ICON_COMPONENTS: Record<DashboardCategoryIconKey, LucideIcon> = {
  wrench: Wrench,
  hammer: Hammer,
...
const FALLBACK_ICON_BY_SLUG: Partial<Record<string, DashboardCategoryIconKey>> = {
  automotores: "car",
...
export function resolveCategoryIcon(icon?: string | null, slug?: string | null) {
  const explicitKey =
    icon && Object.prototype.hasOwnProperty.call(ICON_COMPONENTS, icon)
      ? (icon as DashboardCategoryIconKey)
      : undefined;
  const key = explicitKey || (slug ? FALLBACK_ICON_BY_SLUG[slug] : undefined) || "briefcase";
