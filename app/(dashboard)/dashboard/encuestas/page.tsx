...
import BarrioFilter from "./_components/barrio-filter"
import { BarrioFilterProvider } from "./_components/barrio-filter-context"
...
async function BarrioFilterWrapper() {
  try {
    const stats = await getEstadisticasEncuestas()
    return (
      <div className="flex items-center justify-between">
        <BarrioFilter
          barrios={stats.encuestasPorBarrio}
        />
    ...
    return (
      <div className="flex items-center justify-center h-12">
        <p className="text-destructive">Error al cargar el filtro de barrios</p>
      </div>
    )
  }
}
